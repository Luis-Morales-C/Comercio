...
public class ClienteTest {
    ...
    public void actualizarClienteTest() {
        ...
        Cliente cliente = clienteRepo.findById("666c98d9bd085915f091c84f").orElseThrow();
        ...
        Cliente clienteActualizado = clienteRepo.findById("666c98d9bd085915f091c84f").orElseThrow();
        ;
    ...
    //Borramos el cliente con el id XXXXXXX
        clienteRepo.deleteById("666c98d9bd085915f091c84f");
        //Obtenemos el cliente con el id XXXXXXX
        Cliente cliente = clienteRepo.findById("666c98d9bd085915f091c84f").orElse(null);
